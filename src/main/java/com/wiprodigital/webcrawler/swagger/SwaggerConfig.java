package com.wiprodigital.webcrawler.swagger;
...
public class SwaggerConfig {
    ...
    private ApiInfo buildApiInfo(String ver) {
        return new ApiInfoBuilder()
                .title("Web Crawler")
                .description("REST Api for Web Crawler")
                .contact(new Contact("Wipro Digital", "http://wiprodigital.com/", "buildit@wiprodigital.com"))
                .version(ver)
                .build();
    }
